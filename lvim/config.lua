...
-- BEGIN make java great again
local lombok_jar = "/home/ben/.config/nvim/dependencies/lombok.jar"
...
local opts = {
  ...
  root_dir = require 'lspconfig'.util.find_git_ancestor -- maven multi projects
}

require("lvim.lsp.manager").setup("jdtls", opts)

-- END make java... sigh... who am i kinnding?
